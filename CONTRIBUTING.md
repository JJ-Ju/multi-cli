...
To start the Ionesco CLI from the source code (after building), run the following command from the root directory:
...
The integration tests are designed to validate the end-to-end functionality of the Ionesco CLI. They are not run as part of the default `npm run test` command.
...
- `packages/`: Contains the individual sub-packages of the project.
  ...
  - `core/`: The core backend logic for the Ionesco CLI.
...
1.  **Start the Ionesco CLI in development mode:**
