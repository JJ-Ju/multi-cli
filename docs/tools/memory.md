...
This document describes the `save_memory` tool for the Ionesco CLI.

## Description

Use `save_memory` to save and recall information across your Ionesco CLI sessions. With `save_memory`, you can direct the CLI to remember key details across sessions, providing personalized and directed assistance.
